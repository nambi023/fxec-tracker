...
export default function CheckIn() {
  ...
  const [checking, setChecking] = useState(true); // checking whether this slot is already done today
  const [alreadyDone, setAlreadyDone] = useState(null); // existing row if found
  ...
  async function submit() {
    ...
    // Re-check right before inserting, in case the student had two tabs
    // open or submitted twice quickly (avoids a duplicate slot record).
    const todayStart = new Date();
    todayStart.setHours(0, 0, 0, 0);
